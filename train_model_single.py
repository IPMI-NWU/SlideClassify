...
parser.add_argument('--datasetsName', type=str, default='c16', help='directory to save features')
...
def prediction(model, loader, criterion, testing="Val"):
    ...
    print(f"[{testing}]",'[val]\t loss (all):{:.4f}'.format(total_loss), 'WSI acc: {:.4f}\t WSI auc: {:.4f}\t'.format(acc, roc_auc))
    torch.cuda.empty_cache()
