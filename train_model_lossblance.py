...
parser.add_argument('--datasetsName', type=str, default='jiangsu_her2', help='directory to save features')
parser.add_argument('--n_classes', type=int, default=4, help='num of classes for slide')
