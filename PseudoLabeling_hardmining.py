...
for img_id, attn in train_attns.items():
    ###标签值和预测值
    label_gt = result_csv[result_csv['slide_id']==img_id]['label'].tolist()[0]
    pre_result = result_csv[result_csv['slide_id']==img_id]['pre'].tolist()[0]
    ###注意力得分
